...
enum Error_code pc_can_communication_fcu_to_labview_encapsulation(struct PC_can_communication_fcu_to_labview *  p_pc_can_communication_fcu_to_labview, CAN_message * p_can_msg)
{
	...
	{
		//氢气数据，0~17，0x1800BDBC~0x1811BDBC
	case 0:
		p_pc_can_communication_fcu_to_labview->updata_event_time = system_time; //注意了，只有第一帧发送的时候才刷新时间。
	...
	case 17:
		...
		//空气数据， 18~23， 0x1812BDBC~0x1817BDBC   
	case 18:
	...
	case 23:
		...
		//电堆散热系统，24~29, 0x1818BDBC~0x181DBDBC      
	case 24:
	...
	case 29:
		...
		//三合一散热系统， 30~33, 0x181EBDBC~0x1821BDBC             
	case 30:
	...
	case 33:
		...
		//电堆发电数据，34~42,  0x1822BDBC~0x182ABDBC           
	case 34:
