...
#if (!defined(FMSTR_HC12_ALL_MESSAGES)) && (!defined(__S12Z__))
#pragma MESSAGE DISABLE C1420  /* Result of function call is ignored */
#pragma MESSAGE ERROR C3303  /* Concatenation of strings */
...
/* using 16bit addressing commands always makes sense on 16bit HC(S)12(X) platforms */
